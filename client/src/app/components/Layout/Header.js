...
const accounting = [
  {
    name: "Bank Accounts",
    description: "Manage and track all your bank accounts.",
    href: "#",
    icon: BanknotesIcon,
  },
  {
    name: "Balance Sheet",
    description: "Get an overview of your financial position.",
    href: "#",
    icon: DocumentChartBarIcon,
  },
  {
    name: "Profit & Loss",
    description: "Track your profits and losses over time.",
    href: "#",
    icon: ScaleIcon,
  },
  {
...
export default function Header() {
  ...
  const [companyName, setCompanyName] = useState("Affotax");

  return (
    <header className="bg-black z-[9999]">
      <nav
        aria-label="Global"
        className="mx-auto flex max-w-7xl items-center justify-between h-[76px] text-white px-4 lg:px-8"
      >
        <div className="flex items-center gap-[1rem] md:gap-[3rem]">
          <div className="flex lg:flex-1">
            <select
              value={companyName}
              className="bg-transparent w-[7rem] outline-none border border-gray-200 rounded-sm py-[.3rem]"
            >
              <option value={companyName} className="bg-white text-gray-800">
                {companyName}
              </option>
            </select>
          </div>
          ...
          <PopoverGroup className="hidden lg:flex lg:gap-x-12">
            <Link
              href="#"
              className="text-sm/6 font-font-[500] text-white hover:underline transition-all duration-300 ease-in-out py-1"
            >
              Dashboard
            </Link>
            <Popover className="relative">
              <PopoverButton className="flex items-center gap-x-1 text-sm/6 font-[500] text-white hover:underline transition-all duration-300 ease-in-out py-1">
                BookKeeping
                <ChevronDownIcon
                  aria-hidden="true"
            ...
            <Link
              href="#"
              className="text-sm/6 py-1 font-font-[500] text-white hover:underline transition-all duration-300 ease-in-out"
            >
              Contact
            </Link>
          </PopoverGroup>
        ...
        <div className="flex lg:flex-1 lg:justify-end">
          <div className="flex items-center gap-4 sm:gap-6">
            <div className="flex items-center gap-4">
              ...
              <span className="cursor-pointer text-white">
                <BiSolidBell className="h-5 w-5 text-white" />
              </span>
              <span className="cursor-pointer text-white">
                <RiQuestionLine className="h-5 w-5 text-white" />
              </span>
            </div>
            ...
            <div className="hidden lg:flex w-[3rem] relative h-[3rem] rounded-full overflow-hidden cursor-pointer">
              <Image
                src="/profile.png"
                alt="avatar"
                layout="fill"
