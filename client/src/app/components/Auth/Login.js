...
export default function Login({ setActive }) {
  ...
  const { auth, setAuth, setAuthShow } = useAuth();
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if (data) {
        ...
        Cookies.set("socialmarket", data.token, {
          expires: 1,
          secure: true,
          sameSite: "Strict",
          path: "/",
  ...
  const handleSocialAuth = async () => {
    ...
    try {
      ...
      if (data) {
        ...
        localStorage.setItem("socialmarket", JSON.stringify(data));
        ...
        <form onSubmit={handleLogin} className="">
          <div className="flex items-center justify-center flex-col gap-2 w-full">
            ...
            <div className="flex flex-col gap-4 w-full mt-4 ">
              ...
              <div className="relative w-full">
                <span
                  className="absolute top-[.4rem] right-2   z-10  cursor-pointer "
              ...
              <div className="flex items-center justify-center w-full py-4 px-2 sm:px-[2rem]">
                <button
                  type="submit"
                  className={`${CommonStyle.button2} w-[85%] sm:w-[70%] flex items-center justify-center`}
                >
                  {loading ? (
